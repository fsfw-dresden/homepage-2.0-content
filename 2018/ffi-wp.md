...
**Bottom-Up**: Ab 1000 Leuten (100 Euro täglich), die mitmachen, könnte man jeden Tag einen Bug (fixen lassen). Ab da wäre es sinnvoll (ehrenamtlich). Ab 10K Leuten (100 Euro Betriebskosten täglich) könnte es als StartUp überleben.
...
Anmerkung: Wenn es gelänge, den App-Markt auf mobilen Endgeräten einzubeziehen, wäre der Kuchen nochmal deutlich größer (und ein kleineres Stück würde reichen).
...
Beispiele für Bedarf an Finanzierung (digitale Infrastruktur für eine lebendige Zivilgesellschaft):
    - Betrieb und Wartung freier dezentraler Alternativen zu Dropbox, Trello, Google docs, Skype, WhatsApp, Doodle, Polldaddy
    - Server für Wikis, Etherpad, Mailinglisten, Jabber
    - Soziale Netze (Diaspora, Mastodon)

Natürlich besteht auch die bei der Infrastruktur-Software teils erheblicher Entwicklungsbedarf. Auch dieser ließe sich ggf. durch die FFI finanzieren.
