...
Dieser Text beschreibt eine Idee zur Steigerung von Qualität und Verbreitung von freier quelloffener Software ([FLOSS](https://en.wikipedia.org/wiki/Free_and_open-source_software)) und freien dezentralen Web-Diensten.
Er geht nicht darauf ein, *warum* diese Ziele erstrebenswert sind.
Er ist eine stark inspiriert durch [Colin Percivals Plan für Open Source Software Maintainer](http://www.daemonology.net/blog/2017-05-11-plan-for-foss-maintainers.html).
...
Diese kann auf Grund der wesensbestimmenden Freiheit nicht "verkauft" werden.
